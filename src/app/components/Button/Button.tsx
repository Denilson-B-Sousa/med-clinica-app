...
const button = tv({
  base: "box-border flex cursor-pointer items-center justify-center gap-2 font-inter text-sm uppercase transition-all duration-150 disabled:cursor-not-allowed",
  ...
  variants: {
    ...
    variant: {
      ...
      profile: "text-[#0094CB] outline-none focus:outline-none focus-visible:outline-none",
